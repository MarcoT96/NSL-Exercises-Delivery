...
int main(int argc, char** argv){
  ...
  cout << "Compute istantaneous value of the observables" << endl;
  simulation_acceptance=0;
  for(int isteps=0; isteps<M; isteps++){

    accepted=0;
    attempted=0;
    Move();
    if(isteps%50000==0)
      cout << "Completed MC Step " << isteps << endl;
    Measure(path);
    simulation_acceptance+=accepted/attempted;
  
  }
  cout << "Simulation Metropolis Acceptance = " << (simulation_acceptance*1.0)/(M*1.0) << endl << endl; 
  ...
  cout << "Equilibration and estimation of optimal parameters for the simulation" << endl;
  cout << "=======================" << endl;
  ...
  for(int isteps=0; isteps<M; isteps++){
    ...
    attempted = 0;
    Move();
    cout << "MC Step " << isteps << endl;
    Measure(folder);
    cout << "Acceptance ratio = " << accepted/attempted << endl << endl;
  }
  ConfFinal(folder);
  */
